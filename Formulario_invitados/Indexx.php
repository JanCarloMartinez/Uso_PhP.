...
if(file_exists("invitados.txt")){
    $aInvitados = fopen("invitados.txt", "r" );
    $aDocumentos = fgetcsv($aInvitados, 0, ",") ;
} else {
    //sino el aray queda como un array vacio
    $aDocumentos = array();
}
    ...
    $documento = $_REQUEST["txtDocumento"];
        ...
        if(isset($_POST["btnProcesar"])){
            ...
            if(in_array($documento, $aDocumentos)){
                $mensaje = "Bienvenido.";
            } else{ //Sino un mensaje de No se encuentra en la lista de invitados
            ...
            <form method="POST" action="">
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="submit" name="btnProcesar" value="Verificar invitado" class="btn-primary" style="margin-top: 13px;">
                    </div>
                </div>
                <div class="row">
                    <div class="12-col bm-3">
                        ...
                        <input type="submit" name="btnVip" value="Verificar código" class="btn-primary" style="margin-top: px;">
                    </div>
                </div>
            </form>
        </div>
