        ...
        <div class="row">
            <div class="col-3 offset-1 me-6">
                <form action="" method="POST" class="form">
                    ...
                    <button type="submit" name="btnEnviar" class="btn bg-primary text-white">Enviar &nbsp&nbsp<i class="bi bi-cursor-fill"></i></button>
                    <button type="submit" name="btnEliminar" class="btn bg-danger text-white">Eliminar &nbsp&nbsp<i class="bi bi-exclamation-triangle-fill"></i></button>
                </form>
            </div>
